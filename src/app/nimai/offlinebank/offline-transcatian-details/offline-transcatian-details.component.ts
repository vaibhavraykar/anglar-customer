...
@Component({
  selector: 'app-offline-transcatian-details',
  templateUrl: './offline-transcatian-details.component.html',
  styleUrls: ['./offline-transcatian-details.component.css']
})
export class OfflineTranscatianDetailsComponent implements OnInit {
  public ntData: any[] = [];
    ...
    this.nts.getTransQuotationDtlByBankUserIdAndStatus(data).subscribe(
      (response) => {
        ...
        console.log(this.data),' new data';
          ...
          this.updateddata = [];
   if(this.data){
    console.log(this.data,'in if condition');
    this.hasNoRecord=true;
      this.data.forEach( element => {
        ...
        //  newdetails.push(this.updateddata);
