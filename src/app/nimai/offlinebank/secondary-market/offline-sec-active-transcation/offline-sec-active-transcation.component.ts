...
@Component({
  selector: 'app-offline-sec-active-transcation',
  templateUrl: './offline-sec-active-transcation.component.html',
  styleUrls: ['./offline-sec-active-transcation.component.css']
})
export class OfflineSecActiveTranscationComponent implements OnInit {
  public ntData: any[] = [];
...
// }
  ...
  getDetail(detail:any) {
    ...
    if(detail.lcProforma==null || detail.lcProforma=="" || detail.lcProforma==undefined){
      ...
      console.log(this.specificDetail); //new
